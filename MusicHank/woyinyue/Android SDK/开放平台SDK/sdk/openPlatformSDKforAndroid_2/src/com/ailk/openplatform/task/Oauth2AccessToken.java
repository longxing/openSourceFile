...
public class Oauth2AccessToken {
	...
	public static Oauth2AccessToken parseAccessToken(String responseJsonText) {
		if ((!TextUtils.isEmpty(responseJsonText))
			...
			try {
				...
				System.out.println("lww...token = " + token);
				return token;
			} catch (JSONException e) {
				e.printStackTrace();
			}
	...
	public String toString() {
		return "uid: " + this.mUid + ", " + "access_token" + ": "
				+ this.mAccessToken + ", " + "refresh_token" + ": "
				+ this.mRefreshToken + ", " + "expires_in" + ": "
				+ Long.toString(this.mExpiresTime);
	}
