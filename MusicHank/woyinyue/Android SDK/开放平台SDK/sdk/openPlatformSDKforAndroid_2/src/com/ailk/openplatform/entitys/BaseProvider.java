...
public abstract class BaseProvider {
	...
	protected HttpResponse doPostReturnResponse(String url,
		...
		case PARAM_TYPE_MAP:
			...
			System.out.println("lww...requestEntity = " + requestEntity);
	...
	protected HttpResponse getResponse(HttpUriRequest request) {
		HttpResponse httpResponse = null;
		HttpClient httpClient = HttpManagerTool.getHttpClient();
		try {
	...
	protected Map<String, String> addMustParams(Map<String, String> mustParams,
		...
		if (needAccessToken) {
			...
			if (accessToken == null || accessToken.trim().equals("")) {
				...
				mustParams.put(Constants.RequestParamName.ACCESS_TOKEN,
						accessToken);
				mustParams.put(
						Constants.RequestParamName.DIGEST,
