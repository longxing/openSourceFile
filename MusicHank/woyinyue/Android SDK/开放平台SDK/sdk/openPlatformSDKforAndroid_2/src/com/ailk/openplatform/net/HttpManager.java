...
class HttpManager
{
  ...
  private static HttpResponse requestHttpExecute(String url, String method, Parameters params)
  {
  ...
  private static void buildParams(OutputStream baos, Parameters params)
    throws SDKException
  {
    try
    {
  ...
  private static SSLSocketFactory getSSLSocketFactory()
  {
    if (sSSLSocketFactory == null) {
      try {
        ...
        InputStream caInput = HttpManager.class.getResourceAsStream("cacert.cer");
        Certificate ca;
        try {
